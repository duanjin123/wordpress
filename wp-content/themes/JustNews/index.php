<?php get_header();?>
    <div class="main container">
        <div class="content">
            <?php if(isset($options['slider_img']) && $options['slider_img'] && $options['slider_img'][0]){ ?>
                <div class="slider-wrap clearfix">
                    ...
                    <?php if(isset($options['fea_img']) && $options['fea_img'] && $options['fea_img'][0]){ ?>
                                ...
                                <li>
                                    <?php if(isset($options['fea_url'][$k]) && $options['fea_url'][$k]){ ?>
                                        <a href="<?php echo esc_url($options['fea_url'][$k]); ?>" target="_blank">
                                            <img src="<?php echo esc_url($img); ?>" alt="<?php echo esc_attr($options['fea_title'][$k]); ?>">
                                        </a>
                                ...
                                <li class="topic">
                                    <a class="topic-wrap" href="<?php echo get_term_link($sp->term_id);?>" target="_blank">
                                        <div class="cover-container">
                                            <img src="<?php echo esc_url($thumb);?>" alt="<?php echo esc_attr($sp->name);?>">
                                        </div>
                ...
                <ul class="article-list tab-list active">
                    ...
                    <?php if(max_page()>1){ ?>
                        <li class="load-more-wrap">
                            <a class="load-more" href="javascript:;"><?php _e('Load more posts', 'wpcom');?></a>
                        </li>
                    <?php } ?>
                </ul>
                <?php if($cats){ foreach($cats as $cat){ ?>
            ...
            <div class="sec-panel-body">
                <ul class="list list-partner">
                    ...
                    foreach($partners as $x =>$pt){
                        ...
                        ?>
                        <li>
                            <?php if($url){ ?><a target="_blank" title="<?php echo esc_attr($alt);?>" href="<?php echo esc_url($url);?>"><?php } ?><img style="width:<?php echo $width;?>" src="<?php echo esc_url($pt);?>" alt="<?php echo esc_attr($alt);?>"><?php if($url){ ?></a><?php } ?>
                        </li>
                    <?php } ?>
                </ul>
            </div>
