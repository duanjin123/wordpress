...
class wpcom_products_widget extends WP_Widget {

    public function __construct() {
        parent::__construct( 'lastest-products', '#WPCOM#产品列表', array(
            'classname'   => 'widget_lastest_products',
            'description' => '选择指定产品分类，适合用于显示产品列表信息',
        ) );
    }
