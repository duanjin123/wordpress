    ...
    <div class="container">
        <div class="clearfix">
            ...
            <div class="footer-col footer-col-copy">
                <?php wp_nav_menu( array( 'container' => false, 'depth'=> 1, 'theme_location' => 'footer', 'items_wrap' => '<ul class="footer-nav hidden-xs">%3$s</ul>' ) ); ?>
                <div class="copyright">
                    <?php echo ($copyright=isset($options['copyright'])?$options['copyright']:'')?$copyright:'Copyright © 2017 '.get_bloginfo("name").' 版权所有  Powered by <a href="http://www.wpcom.cn" target="_blank">WordPress</a>'?> <?php echo (isset($options['tongji'])?$options['tongji']:'');?>
                </div>
            </div>
...
<div class="action"<?php echo isset($options['action_top'])?' style="top:'.$options['action_top'].';"':''?>>
    <?php if(isset($options['contact_text'])&&$options['contact_text']){ ?>
