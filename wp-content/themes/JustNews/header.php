        ...
        <div class="collapse navbar-collapse">
            ...
            <div class="navbar-action pull-right">
                ...
                <?php if(function_exists('um_get_core_page')){ ?>
                    ...
                    <div id="j-user-wrap">
                        <a class="login" href="<?php echo um_get_core_page('login');?>"><?php _e('Sign in', 'wpcom');?></a>
                        <a class="login register" href="<?php echo um_get_core_page('register');?>"><?php _e('Sign up', 'wpcom');?></a>
                    </div>
                    <?php if( !isset($is_submit_page) && isset($options['tougao_on']) && $options['tougao_on']=='1' ){ ?><a class="publish" href="<?php echo esc_url(add_post_tab_link());?>">
