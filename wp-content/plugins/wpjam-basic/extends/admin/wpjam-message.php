...
add_filter('user_row_actions', function($actions, $user){
	$actions['message']	= '<a class="thickbox" title="发送站内消息" href="'.admin_url('users.php?page=messages&action=send&receiver='.$user->ID.'&TB_iframe=true&width=780&height=320').'">发送站内消息</a>';
