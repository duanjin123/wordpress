...
include(WPJAM_BASIC_PLUGIN_DIR.'core/admin/admin-menus.php');

include(WPJAM_BASIC_PLUGIN_DIR.'core/admin/hooks.php');
include(WPJAM_BASIC_PLUGIN_DIR.'core/admin/functions.php');
...
add_action('current_screen', function($current_screen){
	...
	if($pagenow == 'post.php' || $pagenow == 'post-new.php'){
		...
		include(WPJAM_BASIC_PLUGIN_DIR.'core/admin/post.php');
	}elseif($pagenow == 'edit.php' || $pagenow == 'upload.php'){
		$post_type	= $current_screen->post_type;

		include(WPJAM_BASIC_PLUGIN_DIR.'core/admin/post-list.php');
	}elseif($pagenow == 'term.php') {
		$taxonomy	= $current_screen->taxonomy;

		include(WPJAM_BASIC_PLUGIN_DIR.'core/admin/term.php');
	}elseif($pagenow == 'edit-tags.php') {
		$taxonomy	= $current_screen->taxonomy;

		include(WPJAM_BASIC_PLUGIN_DIR.'core/admin/term-list.php');
	}
});
...
add_action('wp_loaded', function(){
	if(wp_doing_ajax() && isset($_POST['action'])){
		if($_POST['action'] == 'query_posts'){
			...
			include(WPJAM_BASIC_PLUGIN_DIR.'core/admin/list-table.php');
			add_action('wp_ajax_list-table-action', 'wpjam_list_table_ajax_response');
		}elseif($_POST['action'] == 'wpjam-option-action'){
			include(WPJAM_BASIC_PLUGIN_DIR.'core/admin/options-update.php');
