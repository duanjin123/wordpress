...
class WPJAM_AJAX{
	public static function ajax_response(){
		...
		call_user_func(wpjam_get_filter_name($plugin_page, 'ajax_response'));
	}
	...
	public static function get_button($args){
		...
		return '<a href="javascript:;" style="text-decoration:none;" id="wpjam-button-'.$action.'" class="'.$class.' wpjam-button" data-action="'.$action.'" data-data="'.$data.'" data-nonce="'.wp_create_nonce($plugin_page.'-'.$action).'" data-direct="'.$direct.'" data-confirm="'.$confirm.'"  data-title="'.$page_title.'">'.$button_text.'</a>';
	}
	...
	public static function form($args){
		...
		$action_title	= $action_title?:$submit_text;
		...
		if($fields){
			...
			if($bulk){
				...
				echo '<form method="post" action="#" id="'.$form_id.'" data-bulk="'.$bulk.'" data-ids="'.$ids.'" data-action="'.$action.'" data-nonce="'.$nonce.'" data-title="'.$action_title.'">';
			}else{
				echo '<form method="post" action="#" id="'.$form_id.'" data-id="'.$id.'" data-action="'.$action.'" data-nonce="'.$nonce.'" data-title="'.$action_title.'">';
			}
