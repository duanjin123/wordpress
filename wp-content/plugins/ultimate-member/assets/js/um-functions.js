...
function initCrop_UM() {
	...
	var crop_data = target_img_parent.attr('data-crop');
	var min_width = target_img_parent.attr('data-min_width');
	var min_height = target_img_parent.attr('data-min_height');
	var ratio = target_img_parent.attr('data-ratio');
			...
			if ( crop_data == 'square' ) {
				...
				var opts = {
					...
					dashed: false,
						...
						target_img_parent.attr('data-coord', Math.round(data.x) + ',' + Math.round(data.y) + ',' + Math.round(data.width) + ',' + Math.round(data.height) );
					}
				};
