<div class="um <?php echo $this->get_class( $mode ); ?> um-<?php echo $form_id; ?>">
	...
	<div class="um-form">
			...
			<div class="um-account-main<?php echo function_exists('WC') ? ' woocommerce' : '';?>" data-current_tab="<?php echo $ultimatemember->account->current_tab; ?>">
				...
				foreach( $ultimatemember->account->tabs as $k => $arr ) {
					...
					foreach( $arr as $id => $info ) { extract( $info );
						...
						if ( isset($info['custom']) || um_get_option('account_tab_'.$id ) == 1 || $id == 'general' ) {
							...
							<div<?php echo $title==''?' style="display:none;"':''?> class="um-account-nav uimob340-show uimob500-show"><a href="#" data-tab="<?php echo $id; ?>" class="<?php if ( $id == $current_tab ) echo 'current'; ?>"><?php echo $title; ?>
							...
							if($ultimatemember->account->current_tab == $id){ do_action('um_before_form', $args); }
