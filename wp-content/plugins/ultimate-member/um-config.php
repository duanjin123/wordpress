...
$this->sections[] = array(
    ...
    'fields'     => array(
        ...
        array(
				...
				'default' 		=> 1,
				'desc' 	   		=> __('Enable/disable the Password account tab in account page','ultimatemember'),
				'on'			=> __('On','ultimatemember'),
				'off'			=> __('Off','ultimatemember'),
        ),

        array(
                'id'       		=> $show_profile ? 'account_tab_privacy' :'',
                'type'     		=> $show_profile ? 'switch' : '',
                'title'   		=> $show_profile ? __( 'Privacy Account Tab','ultimatemember' ) : '',
				'default' 		=> 1,
        ...
        array(
                'id'       		=> $show_profile ? 'account_hide_in_directory' : '',
                'type'     		=> $show_profile ? 'switch' : '',
                'title'   		=> $show_profile ? __( 'Allow users to hide their profiles from directory','ultimatemember' ) : '',
				'default' 		=> 1,
...
$this->sections[] = array(
    ...
    'fields'     => array(
		...
		array(
                ...
                'type'     		=> 'select',
				'select2'		=> array( 'allowClear' => 0, 'minimumResultsForSearch' => -1 ),
                'title'    		=> __( 'Profile Field Icons','ultimatemember' ),
