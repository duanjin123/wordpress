...
class UM_Admin_Dashboard {
	...
	***/
	function on_load_page() {
		...
		add_meta_box('um-metaboxes-mainbox-1', __('Purge Temp Files','ultimate-member'), array(&$this, 'purge_temp'), $this->pagehook, 'normal', 'core');
		add_meta_box('um-metaboxes-sidebox-1', __('User Cache','ultimate-member'), array(&$this, 'user_cache'), $this->pagehook, 'side', 'core');
