<?php
	...
	**/
	...
	function um_category_access_fields_edit( $term ){
		...
		$_um_accessible= (isset( $termMeta['_um_accessible'] ) )? $termMeta['_um_accessible'] : 0;
		...
		echo "<tr class='form-field term-roles-wrap'>";
		...
		echo "<tr class='form-field term-redirect-wrap'>";
	...
	***/
	...
	function um_admin_do_action__mass_role_sync( $action ){
		...
		if ( urldecode($slug) != $_REQUEST['um_role'] )
