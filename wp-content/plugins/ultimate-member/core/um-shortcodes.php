...
class UM_Shortcodes {
	...
	*/
	function load_template($tpl) {
		...
		$theme_file = get_stylesheet_directory() . '/ultimate-member/' . $tpl . '.php';
	...
	*/
	function template_exists($template) {
		...
		$theme_file = get_stylesheet_directory() . '/ultimate-member/' . $template . '.php';
	...
	*/
	function get_templates($excluded = null) {
		...
		if (file_exists(get_stylesheet_directory() . '/ultimate-member/')) {
			$paths[] = glob(get_stylesheet_directory() . '/ultimate-member/' . '*.php');
		}
